...
from planetarium.models import AstronomyShow, PlanetariumDome, Reservation, ShowTheme, ShowSession, Ticket
...
class ModelStrTests(TestCase):
    ...
    def test_show_session_str(self):
        self.assertEqual(str(self.show_session), f"Galactic Wonders at 2024-08-08 15:00")

    def test_ticket_str(self):
        self.assertEqual(str(self.ticket), f"Row: 1, Seat: 1, ShowSession: Galactic Wonders at 2024-08-08 15:00")
